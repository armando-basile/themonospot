...
namespace ThemonospotPluginMkv
{
	...
	public class MkvManager
	{
		...
		// Log4Net object
		private static readonly ILog log = LogManager.GetLogger(typeof(MkvManager));
		...
		/// </param>
		public MkvManager(string mkvFilePath)
		{
		...
		private string ReadElement()
		{
			...
			tmpElement += byteMan.GetHexFromBytes(allBytes);
