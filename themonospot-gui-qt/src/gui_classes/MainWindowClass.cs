...
namespace ThemonospotGuiQt
{
	...
	public partial class MainWindowClass: QMainWindow
	{
		...
		private void OpenFile()
		{
			string selectedFile = 
				QFileDialog.GetOpenFileName(this, 
			                                ...
			                                GlobalData.bFactory.DefaultPath,
		...
		private void SaveReport()
		{
			...
			// generate report
			GlobalData.bFactory
				.SaveReportFile(fiEntity[mainwindow_Ui.tabContainer.CurrentIndex].Video,
		...
		private void ScanFile(string filePath)
		{
			...
			try
			{
				...
				GlobalData.bFactory.GetFileInfo(filePath, ref video, ref audio, ref pluginParameter);
