...
namespace themonospot_Base_Main
{
    ...
    {   
			               ...
			               ref string _saveInfo )
		{
			...
			_saveInfo = "update file header... wait please";
			_redrawInfo=true;
			...
			_saveInfo = "update file content... wait please";
			_redrawInfo = true;
			                       ...
			                       ref string _saveInfo  )
		{
			...
			_saveInfo = "update MOVI chunk... wait please";
			_redrawInfo = true;
			                       ...
			                       ref string _saveInfo )
		{
			...
			_saveInfo = "update IDX chunk... wait please";
			_redrawInfo=true;
